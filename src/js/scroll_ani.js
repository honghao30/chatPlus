	...
	const sceneInfo = [
		{
			...
			scrollHeight: 0,
			objs: {
				container: document.querySelector('.key-visual'),
				messageA: document.querySelector('.key-visual .main-message.a'),
				messageB: document.querySelector('.key-visual .main-message.b'),
				messageC: document.querySelector('.key-visual .main-message.c'),
				messageD: document.querySelector('.key-visual .main-message.d'),
